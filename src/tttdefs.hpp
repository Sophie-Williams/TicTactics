...
template<typename charT, typename Traits>
  std::basic_ostream<charT, Traits>&
  operator<< (std::basic_ostream<charT, Traits>& os, const Square& s)
  {
    switch (s)
      {
...
struct Move
{
  ...
  template<typename charT, typename Traits>
    ...
    operator<< (std::basic_ostream<charT, Traits>& os, const Move& mc)
    {
...
public:
  ...
  bool
  operator!= (const MoveIterator& other) const;
  Move
  operator* () const;
  MoveIterator&
  operator++ ();
